...
impl Image {
    ...
    pub fn to_png(&self) -> Vec<u8> {
        ...
        let img = image::RgbaImage::from_raw(self.header.width as u32, self.header.height as u32, rgba)
    ...
    pub fn from_png(path: &Path, compression: Compression, mip_count: u16) -> Result<Self, PngError> {
    ...
    fn from_dynamic_image(
        ...
        let image = Self {
            header: ImageHeader { width, height, compression, mip_count },
            data: Vec::new(),
        };
